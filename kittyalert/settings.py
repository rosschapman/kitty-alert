"""
Django settings for kittyalert project.
...
WSGI_APPLICATION = "kittyalert.wsgi.application"
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@kittyalert.com")
